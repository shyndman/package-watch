...
1. [x] **Refactor AliExpress scrape state management**
...
2. [x] **Update orchestration in handleAliExpressOrdersDiscovered**
...
4. [x] **Update background.ts dependencies**
...
5. [x] **Update error handling paths**
...
6. [x] **Add unit tests for orchestration** (`lib/background/aliexpress.test.ts`)
...
7. [x] **Add unit tests for message handlers**
...
8. [x] **Add unit tests for error paths**
...
9. [x] **Add integration test** (`lib/background/aliexpress.test.ts`)
   - Test: full AliExpress scrape flow uses single tab lifecycle
   - Verify: navigateScrapeTab called for navigations, closeScrapeTab called once at end
